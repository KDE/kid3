/**
 * \file musicbrainzimportplugin.h
...
#ifndef MUSICBRAINZIMPORTPLUGIN_H
#define MUSICBRAINZIMPORTPLUGIN_H
...
public:
   ...
   * Destructor.
   */
  virtual ~MusicBrainzImportPlugin();
...
#endif // MUSICBRAINZIMPORTPLUGIN_H
