  ...
  if(WITH_TAGLIB)
    ...
    if(TAGLIBCONFIG_EXECUTABLE)
      execute_process(COMMAND ${TAGLIBCONFIG_EXECUTABLE} --libs
              OUTPUT_VARIABLE TAGLIB_LDFLAGS OUTPUT_STRIP_TRAILING_WHITESPACE)
      execute_process(COMMAND ${TAGLIBCONFIG_EXECUTABLE} --cflags
              OUTPUT_VARIABLE TAGLIB_CFLAGS OUTPUT_STRIP_TRAILING_WHITESPACE)
      execute_process(COMMAND ${TAGLIBCONFIG_EXECUTABLE} --version
              OUTPUT_VARIABLE TAGLIB_VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
